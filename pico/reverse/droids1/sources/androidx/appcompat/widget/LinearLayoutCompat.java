                            ...
                            while (i6 < count) {
                                ...
                                if (child4 != null) {
                                    ...
                                    if (maxWidth13 == 8) {
                                        ...
                                        delta4 = delta5;
                                        child4.measure(View.MeasureSpec.makeMeasureSpec(child4.getMeasuredWidth(), 1073741824), View.MeasureSpec.makeMeasureSpec(largestChildHeight3, 1073741824));
                                    } else {
                                        delta4 = delta5;
                                    }
                                } else {
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i4 < count2) {
            ...
            if (child == null) {
                ...
                this.mTotalLength = largestChildWidth7 + measureNullChild(i4);
                ...
                if (largestChildWidth9 == 8) {
                    ...
                    if (widthMode5 != 1073741824 || lp2.width != 0 || lp2.weight <= 0.0f) {
                        ...
                        largestChildWidth2 = widthMode5;
                        widthMode4 = -1;
                        measureChildBeforeLayout(child, i4, widthMeasureSpec, oldWidth2 == 0 ? this.mTotalLength : 0, heightMeasureSpec, 0);
                        ...
                        if (isExactly) {
                            ...
                            this.mTotalLength = i5 + i6 + alternativeMaxHeight10;
                        } else {
                            alternativeMaxHeight6 = weightedMaxHeight3;
                            int totalLength2 = this.mTotalLength;
        ...
        if (maxAscent[1] == -1 && maxAscent[0] == -1 && maxAscent[2] == -1 && maxAscent[3] == -1) {
            ...
            int descent = Math.max(i7, Math.max(i8, Math.max(i9, childState9)));
                ...
                while (i10 < count2) {
                    ...
                    if (child2 == null) {
                        ...
                        if (isExactly) {
                            ...
                            maxHeight3 = maxHeight6;
                            i2 = i10;
                            int i12 = lp3.rightMargin;
                            this.mTotalLength = i11 + lp3.leftMargin + largestChildWidth11 + i12 + getNextLocationOffset(child2);
                        } else {
                            maxHeight3 = maxHeight6;
                            i2 = i10;
                ...
                while (i13 < count2) {
                    ...
                    if (child3 != null) {
                        ...
                        if (alternativeMaxHeight13 == 8) {
                            ...
                            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(largestChildWidth11, 1073741824);
                            largestChildWidth = largestChildWidth11;
                            int largestChildWidth12 = child3.getMeasuredHeight();
                            child3.measure(makeMeasureSpec, View.MeasureSpec.makeMeasureSpec(largestChildWidth12, 1073741824));
                        } else {
                            largestChildWidth = largestChildWidth11;
                        }
                    } else {
            ...
            if (child4 != null) {
                ...
                if (child4.getVisibility() == 8) {
                    ...
                    if (childExtra <= 0.0f) {
                        ...
                        count = count2;
                        int share = (int) ((delta2 * childExtra) / weightSum2);
                    ...
                    int alternativeMaxHeight15 = Math.max(alternativeMaxHeight14, i);
                    if (matchHeight) {
