        ...
        if (layoutTitle || layoutSubtitle) {
            ...
            if (!layoutSubtitle || this.mSubtitleTextView.getMeasuredWidth() <= 0) {
                ...
                if (i != 48) {
                    ...
                    left = left3;
                    alignmentHeight = alignmentHeight2;
                    int space = bottomlp.bottomMargin;
                    titleTop = (((height - paddingBottom) - space) - this.mTitleMarginBottom) - titleHeight;
                } else {
                    int space2 = (height - paddingTop) - paddingBottom;
                    int spaceAbove = (space2 - titleHeight) / 2;
                    int space3 = toplp.topMargin;
                    alignmentHeight = alignmentHeight2;
                    if (spaceAbove < space3 + this.mTitleMarginTop) {
